...
**Answer** Each line of the code is showing us how many classes exist in a term.
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer: A new term has assumed the first position, as it is now in descending order.**
...
**Answer: There is an extra column and the introduction of the variable "department" changed it**
...
Compared to the previous codeblock, what has changed and how did that affect the result? What do the top terms have in common? **Answer: The current data now has an average and median column.**
...
**Answer: The data set now shows more columns for the departments with the minimum or maximum number of seats. The data is sorted in descending order.**
...
1.  What class has the highest average seats?

2.  What term had the lowest number of seats?

3.  In what term did English have the highest number of seats
