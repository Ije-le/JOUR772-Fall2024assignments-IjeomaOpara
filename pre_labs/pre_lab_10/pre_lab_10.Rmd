...
library(janitor)
library(tidycensus)
census_api_key("1aa8fc473d7887a24c133c72a584b7ec8431dd93", install = TRUE, overwrite = TRUE)
```
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **Answer the bigger the number, the brighter.**
